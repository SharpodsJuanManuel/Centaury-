...
const token = "7336936415:AAHo32MhkNiCgECcg2FUuufKzbhbNAXkwr4";
const bot = new TelegramBot(token, { polling: true });

const channel = { id: '-1002223116442', name: 'Club Centauri 💎' };
    ...
    try {
      ...
      if (userEmail && userEmail.isActive) {
        ...
        await bot.sendMessage(chatId, 'Gracias por enviar tu correo. Aquí está tu invitación:', {
          reply_markup: {
            inline_keyboard: [
              [{ text: 'Unirse al Club Centauri 💎', url: inviteLink.invite_link }]
            ]
          }
        });
